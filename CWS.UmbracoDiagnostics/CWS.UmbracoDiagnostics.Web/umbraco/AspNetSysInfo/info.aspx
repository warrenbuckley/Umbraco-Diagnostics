<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="../masterpages/umbracoPage.Master" %>
...
<script runat="server">
    ...
    private DataTable GetSystemInfo()
    {
            ...
            case PlatformID.Win32NT:
                switch (os.Version.Major)
                {
                    ...
                    case 6:
						...
						{
							case 0:
								text = "Microsoft Windows Vista";
								break;
							case 1:
								text = "Microsoft Windows 7";
								break;
							case 3:
								text = "Microsoft Windows Server 2008";
								break;
							default:
								text = "Microsoft Windows NT 6.x";
								break;
						}
						break;
                }
        ...
        text = string.Format("{0} -- {1}", text, os.VersionString);
		...
		//  Hosting Info
		Assign(table, "Trust Level", this.GetCurrentTrustLevel().ToString());
        return table;
    }
    ...
    private void LoadInformation(DataTable table)
    {
		...
		foreach (DataRow row in table.Rows)
		{
			...
			property.Text = row["Name"].ToString();
			...
			property.Controls.Add(value);

			// add the property to the pane
			pane.Controls.Add(property);
		}
		
		// add the pane to the panel
		this.UmbracoPanel1.Controls.Add(pane);
    }
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
	...
	<cc1:UmbracoPanel ID="UmbracoPanel1" runat="server" Text="ASP.NET System Information"></cc1:UmbracoPanel>
